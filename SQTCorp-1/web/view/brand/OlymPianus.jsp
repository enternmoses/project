        ...
        <div>
            ...
            <div>
                <h2 style="width: 100%; text-align: center; border-bottom: 2px solid #000; line-height: 0.1em; margin: 10px 0 20px;">
                    <span style="background:#fff; padding:0 10px; ">Đồng hồ Olym Pianus</span>
                </h2>
            </div> <br>
                
            <div class="row" style="padding: 0px 100px;">
                <% ArrayList<Product> list = Database.getMiniProduct("Select * from product where brand ='OLYM PIANUS'");%>
                <%
                String pattern = "###,###.##";
